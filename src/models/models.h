...
struct llama_model_sabaki : public llama_model_base {
    llama_model_sabaki(const struct llama_model_params & params) : llama_model_base(params) {}
    void load_arch_hparams(llama_model_loader & ml) override;
    void load_arch_tensors(llama_model_loader & ml) override;
    bool load_tensors(llama_model_loader & ml) override;

    std::vector<ggml_context_ptr> constant_contexts;
    std::vector<ggml_backend_buffer_ptr> constant_buffers;
    std::vector<ggml_tensor *> decay_exp;
    std::vector<ggml_tensor *> conv_qkv;
