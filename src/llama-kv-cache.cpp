...
llama_kv_cache::llama_kv_cache(
    ...
    // Sabaki rotates its whole latent key while retaining unrotated values.
    // The usual MLA optimization of aliasing V to the K cache is invalid here.
    const bool is_mla = hparams.is_mla() && model.arch != LLM_ARCH_SABAKI;
